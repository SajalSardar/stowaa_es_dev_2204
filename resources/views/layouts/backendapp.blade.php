...
<head>
    ...
    <link type="text/css" href="{{ asset('backend/perfect-scrollbar.css') }}" rel="stylesheet">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div id="account_menu" class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item" href="profile.html"><i
                                            class="material-icons">account_circle</i> My
                                        profile</a>
                    ...
                    <div class="mdk-drawer__content">
                        <div class="sidebar sidebar-light sidebar-left sidebar-p-t" data-perfect-scrollbar>
                            ...
                            <ul class="sidebar-menu">
                                ...
                                <li
                                    class="sidebar-menu-item {{ Route::is('backend.product.*') ? 'active open' : '' }}">
                                    ...
                                    <ul class="sidebar-submenu collapse" id="product_menu">
                                        <li
                                            class="sidebar-menu-item {{ Route::is('backend.product.index') ? 'active' : '' }}">
                                        ...
                                        <li
                                            class="sidebar-menu-item {{ Route::is('backend.product.create') ? 'active' : '' }}">
                                            <a class="sidebar-menu-button"
                                        ...
                                        <li
                                            class="sidebar-menu-item {{ Route::is('backend.product.category.index') ? 'active' : '' }}">
                                            <a class="sidebar-menu-button"
                                ...
                                @canany(['add role', 'see role'])
                                    <li class="sidebar-menu-item {{ Route::is('backend.role.*') ? 'active open' : '' }}">
                                        ...
                                        <ul class="sidebar-submenu collapse" id="role_menu">
                                            @can('add role')
                                                <li
                                                    class="sidebar-menu-item {{ Route::is('backend.role.create') ? 'active' : '' }}">
                                            ...
                                            @can('see role')
                                                <li
                                                    class="sidebar-menu-item {{ Route::is('backend.role.index') ? 'active' : '' }}">
