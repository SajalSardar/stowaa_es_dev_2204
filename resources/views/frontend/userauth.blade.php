...
@section('title', "Login & Registation")
      ...
      <div class="row justify-content-center">
          <div class="col-lg-8">
              ...
              <ul class="nav register_tabnav ul_li_center" role="tablist">
                  ...
                  <li role="presentation">
                      <button data-bs-toggle="tab" data-bs-target="#signup_tab" type="button" role="tab" aria-controls="signup_tab" aria-selected="false" class="">Register</button>
                  </li>
              </ul>
